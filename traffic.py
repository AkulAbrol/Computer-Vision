...
# Load the video
video_path = r"C:\Users\DELL\OneDrive\Desktop\Adaptive-Traffic-Signal-Timer 1\Code\YOLO\darkflow\cars_v\26.09.2024_11.22.09_REC.mp4" # Replace with the path to your video
cap = cv2.VideoCapture(video_path)
top, bottom, left, right = 50, 50, 50, 50  # Margin size in pixels
border_color = (0, 255, 0)  # Green border (B, G, R format)
